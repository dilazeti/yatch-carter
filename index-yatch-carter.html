...
<head>
     ...
     <!-- Page Title -->
     <title>Seaventures | Yatch Carter</title>
    
    <!-- Favicon -->
    <link href="yatch-carter/img/favicon.ico" rel="icon">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 mt-auto mb-auto">
                    <ul class="d-flex mb-0 top-info">
                        <li class="c-links d-none d-lg-block"><span><i class="lab la-whatsapp"></i></span><a href="#">+(62) 8222 8466 500</a></li>
                    </ul>
                </div>
    ...
    <nav class="navbar navbar-top-default navbar-expand-lg navbar-simple nav-line">
        ...
        <div class="row no-gutters w-100">
            <div class="col-6 col-lg-3 offset-3 offset-lg-0">
                <a href="index-yatch-carter.html" title="Logo" class="logo fixed-nav-items">
                    <!--Logo Default-->
                    <img src="yatch-carter/img/logo.png" alt="logo" class="logo-dark">
                </a>
            </div>
            <!--Nav Links-->
                    ...
                    <ul class="navbar-nav ml-auto mr-auto">
                       ...
                       <!-- <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="yatch-carter/product-listing.html"><i class="las la-angle-double-right"></i> Product Listing</a>
                                <a class="dropdown-item" href="yatch-carter/product-detail.html"><i class="las la-angle-double-right"></i> Product Detail</a>
    ...
    <div class="inner-wrapper">
        ...
        <nav class="side-nav w-100">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="yatch-carter/product-listing.html">Collections</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="yatch-carter/standard-blog.html">News</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="yatch-carter/contact-us.html">Contact Us</a>
                </li>
            </ul>
        </nav>
        ...
        <div class="side-footer w-100">
            ...
            <p class="text-dark">&copy; 2023 Pemroweb. Made With Love by KaliTiga</p>
        </div>
    </div>
</div>
        ...
        <div id="rev_slider_18_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
            ...
            <ul>	<!-- SLIDE  -->
                <li data-index="rs-44" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/100x50_3d469-bg-light-1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="yatch-carter/img/banner-5.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 5; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 300; color: #fff; letter-spacing:0;font-family:'Poppins', sans-serif;">With Seaventures</div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 52px; line-height: 82px; font-weight: 500; color: #17252a ; letter-spacing: 0;font-family:'Poppins', sans-serif;">Indulge in Luxury</div>
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption   tp-resizeme"
                         id="slide-44-layer-3"
                         data-x="['left','left','center','center']" data-hoffset="['0','150','0','0']"
                         ...
                         data-paddingbottom="[0,0,0,0]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 16px; line-height: 26px; font-weight: 400; color: #fff; letter-spacing:0;font-family:Poppins;">Escape the Ordinary and Immerse Yourself in the Ultimate Yachting Experience with our Luxurious Charter Fleet. </div>
                    ...
                    <div class="tp-caption  tp-resizeme"
                         ...
                         style="z-index: 8; font-family:Poppins;"><a class="btn web-btn rounded-pill" href="#featured-items">Explore</a></div>
                </li>
                <!-- SLIDE  -->
                <li data-index="rs-45" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/100x50_3d469-bg-light-1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="yatch-carter/img/banner-2.jpg" alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <div class="slider-overlay"></div>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 5; white-space: nowrap; font-size: 20px; line-height: 46px; font-weight: 300; color: #fff; letter-spacing:0;font-family:'Poppins', sans-serif;">Your Dream Yacht Awaits</div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 52px; line-height: 82px; font-weight: 500; color: #17252a; letter-spacing: 0;font-family: 'Poppins', sans-serif;">Escape to Paradise</div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 16px; line-height: 26px; font-weight: 400; color: #fff; letter-spacing:0;font-family:Poppins;">Unleash Your Inner Explorer and Revel in the Lap of Luxury with our Bespoke Yacht Charters. </div>
                ...
                <li data-index="rs-46" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="assets/100x50_3d469-bg-light-1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="yatch-carter/img/banner-3.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    <div class="slider-overlay"></div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 5; white-space: nowrap; font-size: 28px; line-height: 46px; font-weight: 400; color: #000; letter-spacing:0;font-family:'Poppins', sans-serif;">Discover the Ocean's Splendor </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 52px; line-height: 82px; font-weight: 500; color: #25274d; letter-spacing:0;font-family: 'Poppins', sans-serif;">Sail in Style</div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 7; min-width: 600px; max-width: 600px; white-space: normal; font-size: 16px; line-height: 26px; font-weight: 400; color: #000; letter-spacing:0;font-family:Poppins;">Discover a World of Opulence and Indulgence with our Premier Yacht Charter Services. </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 8; font-family:Poppins;"><a class="btn rounded-pill web-btn scroll" href="#about">Explore</a></div>
                </li>
    ...
    <div class="container">
        ...
        <div class="col-12 col-md-6 col-lg-3 text-center mini-s">
            <div class="mini-service-card">
                ...
                <h4 class="mini-service-heading">Extensive Selection</h4>
                <span class="small-des">Best rates guaranteed & personalised service to help pick your ideal yacht & itinerary. </span>
            </div>
        </div>
        <div class="col-12 col-md-6 col-lg-3 text-center mini-s">
            <div class="mini-service-card">
                <div class="service-icon"><i class="las la-headset"></i></div>
                <h4 class="mini-service-heading">Expert Guidance</h4>
                <span class="small-des">A bespoke escape designed by a trustworthy team with unparalleled knowledge and excellent connections.</span>
            </div>
        </div>
        <div class="col-12 col-md-6 col-lg-3 text-center mini-s">
            <div class="mini-service-card">
                <div class="service-icon"><i class="las la-lightbulb"></i></div>
                <h4 class="mini-service-heading">Attention to Detail</h4>
                <span class="small-des">Round-the-clock assistance before, during & after your private charter. Every aspect of your charter is meticulously planned.</span>
            </div>
        </div>
        <div class="col-12 col-md-6 col-lg-3 text-center mini-s">
            <div class="mini-service-card">
                <div class="service-icon"><i class="las la-user-check"></i></div>
                <h4 class="mini-service-heading">Personalized Service</h4>
                <span class="small-des">Access to our black book of specialist guides, spa therapists, marine biologists & more.</span>
            </div>
        </div>
    </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <div class="heading-details mb-0">
                    <h4 class="heading">Our Collections</h4>
                </div>
            </div>
            <div class="col-12 col-md-8 offset-md-2 text-center mb-4">
                <p class="text">Chartering a private yacht is the best way to explore Indonesia's vast archipelago. With 10 years of proven expertise in remote destinations, we plan unique adventures tailored to you.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4 text-center wow slideInUp">
                    <div class="featured-item-card">
                        <div class="item-img">
                            <img src="yatch-carter/img/prana.jpg">
                        ...
                        <div class="item-detail">
                            <h4 class="item-name">Prana by Alzaro</h4>
                            <ul class="reviews">
                            ...
                            <p class="item-price">55M | 9 Cabins | 18 Guests | 18 Crew</p>
                        </div>
                    </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 text-center wow slideInUp">
                <div class="featured-item-card">
                    <div class="item-img">
                        <img src="yatch-carter/img/dunia-baru-1.png">
                        <div class="item-overlay">
                            <div class="item-btns">
                    ...
                    <div class="item-detail">
                        <h4 class="item-name">Dunia Baru</h4>
                        <ul class="reviews">
                            <li><i class="las la-star"></i></li>
                            <li><i class="las la-star"></i></li>
                            <li><i class="las la-star"></i></li>
                        ...
                        <p class="item-price">51M  |  7 CABINS  |  14 GUESTS  |  18 CREW</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 text-center wow slideInUp">
                <div class="featured-item-card">
                    ...
                    <div class="item-detail">
                        <h4 class="item-name">Si Datu Bua</h4>
                        <ul class="reviews">
                            <li><i class="las la-star"></i></li>
                            <li><i class="las la-star"></i></li>
                            <li><i class="las la-star"></i></li>
                        ...
                        <p class="item-price">40M  |  3 CABINS  |  6 GUESTS  |  12 CREW</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 text-center wow slideInUp">
            ...
            <div class="col-12 col-md-6 col-lg-4 text-center wow slideInUp">
                <div class="featured-item-card">
                    ...
                    <div class="item-detail">
                        <h4 class="item-name">Silolona</h4>
                        <ul class="reviews">
                            <li><i class="las la-star"></i></li>
                            <li><i class="las la-star"></i></li>
                            <li><i class="las la-star"></i></li>
                        ...
                        <p class="item-price">50M  |  5 CABINS  |  10 GUESTS  |  17 CREW</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 text-center wow slideInUp">
                <div class="featured-item-card">
                    ...
                    <div class="item-detail">
                        <h4 class="item-name">Magia II</h4>
                        <ul class="reviews">
                            <li><i class="las la-star"></i></li>
                            <li><i class="las la-star"></i></li>
                            <li><i class="las la-star"></i></li>
                        ...
                        <p class="item-price">26M  |  4 CABINS  |  8 GUESTS  |  8 CREW                        </p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12 text-center mt-5">
                <a href="yatch-carter/product-listing.html" class="btn web-btn rounded-pill">Load More <i class="las la-arrow-right"></i> </a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="banner-inner-content">
                    ...
                    <div class="count-down-date">
                        ...
                        <div class="img-container">
                            <img src="yatch-carter/img/pngegg.png">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="best-products-carousel owl-carousel owl-themesss">
                    <div class="item text-center">
                        <div class="product">
                            <div class="product-img">
                                <img src="yatch-carter/img/fadila.jpeg">
                            </div>
                            <div class="product-detail">
                                <span class="product-cat">Project Manager</span>
                                <h4 class="product-name">Fadila Zeti</h4>
                    ...
                    <div class="item text-center">
                        <div class="product">
                            <div class="product-img">
                                <img src="yatch-carter/img/vania.jpeg">
                                
                            </div>
                            <div class="product-detail">
                                <span class="product-cat">Project Team Member</span>
                                <h4 class="product-name">Vania Faustina</h4>
                                <span class="fly-line"></span>
                                <ul class="social-icons-simple">
                                    <li><a class="facebook" href="javascript:void(0)"><i class="fab fa-facebook-f"></i> </a> </li>
                                    <li><a class="twitter" href="javascript:void(0)"><i class="fab fa-twitter"></i> </a> </li>
                    ...
                    <div class="item text-center">
                        <div class="product">
                            <div class="product-img">
                                <img src="yatch-carter/img/satria.jpeg">
                                
                            </div>
                            <div class="product-detail">
                                <span class="product-cat">Business Analyst</span>
                                <h4 class="product-name">Satria</h4>
                                <span class="fly-line"></span>
                                <ul class="social-icons-simple">
                                    <li><a class="facebook" href="javascript:void(0)"><i class="fab fa-facebook-f"></i> </a> </li>
                                    <li><a class="twitter" href="javascript:void(0)"><i class="fab fa-twitter"></i> </a> </li>
                    ...
                    <div class="item text-center">
                        <div class="product">
                            <div class="product-img">
                                <img src="yatch-carter/img/yulnesti-removebg-preview.jpg">
                                
                            </div>
                            <div class="product-detail">
                                <span class="product-cat">Project Sponsor</span>
                                <h4 class="product-name">Yulnesti Triani</h4>
                                <span class="fly-line"></span>
                                <ul class="social-icons-simple">
                                    <li><a class="facebook" href="javascript:void(0)"><i class="fab fa-facebook-f"></i> </a> </li>
                                    <li><a class="twitter" href="javascript:void(0)"><i class="fab fa-twitter"></i> </a> </li>
        ...
        <div class="row services-area">
            <div class="col-12 col-lg-4 services text-center wow fadeInUp" data-wow-delay=".2s">
                <div class="service-card">
                    <div class="image-holder"><i class="las la-people-carry"></i></div>
                    <h4 class="service-heading">Who We Are?</h4>
                    <p class="text">At SEAVENTURES, We are a team of dedicated professionals who are passionate about luxury yacht charters.</p>
            ...
            <div class="col-12 col-lg-4 services text-center wow fadeInUp" data-wow-delay=".3s">
                <div class="service-card">
                    <div class="image-holder"><i class="las la-ship"></i></div>
                    <h4 class="service-heading">What We Do?</h4>
                    <p class="text">Our mission is to provide our clients with unforgettable journeys, filled with opulence, relaxation, and adventure.</p>
                    <a href="#" class="btn web-trans-btn rounded-pill">Read More</a>
                </div>
            </div>
            <div class="col-12 col-lg-4 services text-center wow fadeInUp" data-wow-delay=".4s">
                <div class="service-card">
                    <div class="image-holder"><i class="las la-heart"></i></div>
                    <h4 class="service-heading">Why Choose Us?</h4>
                    <p class="text">We are committed to delivering unparalleled service and a journey that will exceed your expectations.</p>
                    <a href="#" class="btn web-trans-btn rounded-pill">Read More</a>
                </div>
            </div>
        </div>-->
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-12 text-center">
                <p class="company-about fadeIn">© 2023 SEAVENTURES. Made With Love By <a href="javascript:void(0);">KaliTiga</a>
                </p>
            </div>
        </div>
    </div>
...
<section class="shop-card-window hidden" id="shop-card-window">
    ...
    <div class="shop-card-window-content">
        ...
        <div class="mini-bag">
            <div class="bag-item">
                <div class="item-img">
                    <img src="yatch-carter/img/item1.jpg">
                </div>
            ...
            <div class="bag-item">
                <div class="item-img">
                    <img src="yatch-carter/img/item2.jpg">
                </div>
                <div class="item-details">
                    <h4 class="item-name">Product Name</h4>
                    <span class="item-qty">Qty: 2</span>
            ...
            <div class="bag-item">
                <div class="item-img">
                    <img src="yatch-carter/img/item3.jpg">
                </div>
                <div class="item-details">
                    <h4 class="item-name">Product Name</h4>
                    <span class="item-qty">Qty: 2</span>
            ...
            <div class="bag-item">
                <div class="item-img">
                    <img src="yatch-carter/img/item4.jpg">
                </div>
                <div class="item-details">
                    <h4 class="item-name">Product Name</h4>
                    <span class="item-qty">Qty: 2</span>
...
<script src="yatch-carter/js/map.js"></script>
<!--Tilt Js-->
<!-- custom script-->
<script src="yatch-carter/js/countdown.js"></script>
<script src="yatch-carter/js/script.js"></script>
